...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   new_helper_functions5.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: bmestini <bmestini@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/10/08 08:48:39 by bmestini          #+#    #+#             */
/*   Updated: 2024/10/08 08:48:41 by bmestini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	while (str[i])
// 	{
// 		nb_quote(str[i], nb_quote_single, nb_quote_double);
